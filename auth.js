...
(function() {
  ...
  style.textContent = `
    ...
    .auth-btn:hover {
      ...
      box-shadow: 0 4px 12px rgba(254,204,7,0.4);
    }
  ...
  gate.innerHTML = `
    <div class="auth-box">
      ...
      <p class="auth-desc">Sign in with your Grain account to access website statistics.</p>
      <div class="auth-error" id="authError">Access restricted to @grain.com.sg accounts.</div>
